...
SRCS += stm32g0xx_hal_gpio.c stm32g0xx_hal_exti.c
SRCS += stm32g0xx_hal_adc.c stm32g0xx_hal_adc_ex.c stm32g0xx_hal_fdcan.c stm32g0xx_hal_flash_ex.c stm32g0xx_hal_tim.c 
SRCS += stm32g0xx_hal_rcc.c stm32g0xx_hal_tim_ex.c app_serial.c app_clock.c stm32g0xx_hal_rtc.c  stm32g0xx_hal_pwr.c 
SRCS += stm32g0xx_hal_rcc.c stm32g0xx_hal_pwr_ex.c stm32g0xx_hal_rcc_ex.c stm32g0xx_hal_iwdg.c hel_lcd.c app_bsp.c
SRCS +=	stm32g0xx_hal_spi.c app_display.c stm32g0xx_hal_wwdg.c hil_queue.c scheduler.c stm32g0xx_hal_rtc_ex.c
